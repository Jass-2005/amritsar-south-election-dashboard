    ...
    <div className="modal-overlay" onClick={onClose} role="dialog" aria-modal="true">
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dsidein-print-watermark" aria-hidden="true">
          ...
          <div className="watermark-sub-name">19-AMRITSAR SOUTH BOOTH INTELLIGENCE</div>
        ...
        <div className="print-dossier-banner">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div>
              <div className="print-dossier-title">19-AMRITSAR SOUTH ASSEMBLY SEGMENT — BOOTH DOSSIER</div>
        ...
        <div className="compare-grid">
          ...
          <div className="year-card">
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>AAP (Dr. Inderbir Singh Nijjar)</span>
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>SAD (Talbir Singh Gill)</span>
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>INC (Inderbir Singh Bolaria)</span>
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>PLC/BJP (Harjinder Thekedar)</span>
                <span><strong>{d22.bjp || d22.plc || 0}</strong> ({d22.plc_pct || d22.bjp_pct || 0}%)</span>
              </div>
              <div className="vote-bar-track">
                <div className="vote-bar-fill" style={{ width: getWidth(d22.bjp || d22.plc, d22.total), background: 'var(--color-bjp)' }} />
              </div>
            </div>
          ...
          <div className="year-card">
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>AAP (Kuldeep Singh Dhaliwal)</span>
            ...
            <div className="vote-bar-wrap">
              <div className="vote-bar-label">
                <span>BJP (Taranjit Singh Sandhu)</span>
            ...
            <div className="vote-bar-wrap">
              ...
              <div className="vote-bar-track">
                <div className="vote-bar-fill" style={{ width: getWidth(d24.sad, d24.total), background: 'var(--color-sad, #7c3aed)' }} />
              </div>
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '12px', fontSize: '0.8125rem' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 700, color: 'var(--color-bjp)' }}>
                +{comp.bjp_gain || comp.bjp_swing || 0}% ({d24.bjp} votes)
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="modal-masterplan-box">
              ...
              <div className="masterplan-title-wrap">
                ...
                <div>
                  <h3 className="masterplan-title">
                    {mpLang === 'PA' ? '169 ਬੂਥ ਵਿਸਥਾਰਤ ਮਾਸਟਰ ਪਲਾਨ (Field Operations)' : '169-Booth Strategic Master Plan'}
                  </h3>
            ...
            <div className="masterplan-download-row no-print">
              <a 
                ...
                title="Download 169-Booth Detailed Field Operations Plan in Punjabi (PDF with Watermark)"
              >
                <Download size={14} />
                <span>169 ਬੂਥ ਮਾਸਟਰ ਪਲਾਨ (ਪੰਜਾਬੀ PDF)</span>
              </a>
              ...
              <a 
                ...
                title="Download 169-Booth Master Plan Document in English (PDF with Watermark)"
              >
                <Download size={14} />
